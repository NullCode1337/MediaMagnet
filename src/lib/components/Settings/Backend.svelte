...
<div class="space-y-5">
  <div class="flex items-center gap-2">
    ...
    <Label class="text-xs font-bold uppercase tracking-widest text-primary">
      YouTube (yt-dlp)
    </Label>
  </div>
  ...
  <div class="p-5 rounded-2xl border bg-card space-y-5">
    <div class="space-y-2">
      <Label for="yt_format" class="text-sm font-medium">Format / Quality</Label
      >
    ...
    <div class="space-y-2">
      ...
      >
      <p class="text-xs text-muted-foreground">
        yt-dlp <code class="bg-muted px-1 rounded">-o</code> filename template.
        Use
