...
{#if !showDecor}
  <div
    ...
    class="h-10 w-full bg-background border-b flex justify-between items-center sticky top-0 z-[100] select-none"
  >
    <div class="flex items-center px-4 gap-3 pointer-events-none">
      <img src="/static/favicon.png" alt="logo" class="w-4 h-5 opacity-70" />
      <span
        class="text-[12px] font-medium text-muted-foreground tracking-widest"
        >MediaMagnet</span
      >
    </div>
